    ...
    <section id="projects" className="py-20 lg:py-32 w-[90%] lg:w-[75%] mx-auto relative flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
      ...
      <div className="w-full lg:w-2/3 flex flex-col gap-12 lg:gap-[15vh] pb-[5vh] lg:pb-[10vh]">
        {PORTFOLIO_DATA.projects.map((project, idx) => (
          ...
          >
            <div className="bg-white/95 dark:bg-[#08080a] backdrop-blur-2xl border border-[#0fbcff]/20 dark:border-white/10 rounded-[2rem] lg:rounded-[3rem] p-8 lg:p-14 flex flex-col justify-between group relative w-full overflow-hidden transition-all duration-500 hover:border-[#0fbcff] dark:hover:border-[#0fbcff]/50">
              ...
              <div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 lg:mb-12">
              ...
              <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 pt-6 lg:pt-8 border-t border-[#0fbcff]/20 dark:border-white/10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 shrink-0">
                  <a 
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-slate-100 dark:bg-white/5 text-slate-900 dark:text-white font-bold hover:bg-slate-200 transition-colors w-full sm:w-auto"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#0fbcff] text-white font-bold hover:bg-[#0fbcff]/80 transition-colors shadow-lg shadow-[#0fbcff]/30 w-full sm:w-auto"
                  >

...
export default function Education() {
  ...
  return (
    <section id="education" className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 w-[95%] sm:w-[90%] md:w-[85%] lg:w-[75%] mx-auto overflow-visible relative">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-10 lg:gap-12 relative items-start">
        ...
        <div className="lg:col-span-4 lg:col-start-9 order-first lg:order-last h-full relative">
          <div className="static lg:sticky top-20 md:top-24 lg:top-28 xl:top-32 flex flex-col items-center lg:items-end text-center lg:text-right mb-2 sm:mb-4 lg:mb-0">
            ...
            <p className="font-mono text-[9px] sm:text-[10px] md:text-xs lg:text-sm text-sky-500 uppercase tracking-widest mt-1 sm:mt-2 font-bold">
              // Academic_Background
            </p>
        ...
        <div className="lg:col-span-7 relative order-last lg:order-first" ref={containerRef}>
          ...
          <div className="block lg:hidden absolute left-[3px] sm:left-[5px] md:left-[7px] top-2 bottom-2 w-[1px] sm:w-[1.5px] md:w-[2px] bg-gradient-to-b from-sky-500 via-purple-500 to-teal-500 rounded-full z-0" />
          ...
          <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-12 relative z-10 pb-4 sm:pb-6 md:pb-8 mt-4 lg:mt-0">
            {EDUCATION_DATA.map((item, idx) => (
              ...
              >
                <div className={`absolute left-[-2px] sm:left-[-1px] md:left-0 top-[3px] sm:top-[4px] md:top-[6px] w-2 h-2 sm:w-3 h-3 md:w-4 md:h-4 rounded-full bg-sky-500 shadow-[0_0_10px_rgba(14,165,233,0.8)] border-2 border-white dark:border-[#0a0a0a] z-10`} />
                ...
                <div className="bg-transparent">
                  ...
                  <p className={`text-[10px] sm:text-xs md:text-sm lg:text-base xl:text-lg font-medium mt-0.5 sm:mt-1 mb-1 sm:mb-2 md:mb-3 lg:mb-4 text-sky-500 dark:text-sky-400`}>
                    {item.institution}
                  </p>
